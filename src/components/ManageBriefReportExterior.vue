 ...
 * @LastEditTime: 2021-01-21 15:30:35
-->
<template>
  <div>
...
export default {
  ...
  methods: {
    ...
    // replaceExcelTitleToTitle(worksheet) {
    //   for (let k1 in worksheet) {
    //     if (k1.endsWith(1)) {
    ...
    //       }
    //       for (let k2 in briefReportExterior) {
    //         if (briefReportExterior[k2].field == worksheet[k1].v) {
    //           worksheet[k1].v = briefReportExterior[k2].title;
    //           worksheet[k1].r = "<t>" + briefReportExterior[k2].title + "</t>";
    //           worksheet[k1].h = briefReportExterior[k2].title;
    //           worksheet[k1].w = briefReportExterior[k2].title;
    //         }
    //       }
    //     }
    //   }
    ...
    //     methods.replaceExcelTitleToTitle(sheet);
    //     methods.openDownloadDialog(
    //       methods.sheet2blob(sheet),
