      ...
      <el-row>
        <el-col :span="14" :offset="5">
          <el-tabs tab-position="left" type="border-card">
            <el-tab-pane label="论文">
              ...
              >
                ...
                <vxe-form-item
                  ...
                  :item-render="{
                    name: 'ElAutocomplete',
                    props: { fetchSuggestions: roleFetchSuggestions }
                  }"
                ></vxe-form-item>
                <vxe-form-item
                  field="age"
              ...
              >
                ...
                <vxe-table-column
                  ...
                  :edit-render="{
                    ...
                    props: {
                      ...
                      remoteMethod: remoteStateMethod
                    }
                  }"
                ></vxe-table-column>
                <vxe-table-column
                ...
                <vxe-table-column
                  ...
                  title="ElSwitch"
                  width="100"
                  :cell-render="{ name: 'ElSwitch' }"
                ></vxe-table-column>
                <vxe-table-column
                  field="slider"
                  title="ElSlider"
                  width="200"
                  :cell-render="{ name: 'ElSlider' }"
                ></vxe-table-column>
                <vxe-table-column
                  field="rate"
                  title="ElRate"
            ...
            <el-tab-pane label="专利">专利</el-tab-pane>
            <el-tab-pane label="标准">简报</el-tab-pane>
    ...
    updateStateList() {
      setTimeout(() => {
        ...
        this.tableData.forEach(row => {
          if (
            row.state &&
            !defaultStateList.some(item => item.value === row.state)
          ) {
